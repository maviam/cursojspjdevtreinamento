        ...
        <div class="">
            <div class="main-menu-header">
                ...
                <div class="user-details">
                    <span id="more-details"><%= session.getAttribute("utilizadorAtivo") %><i class="fa fa-caret-down"></i></span>
                </div>
            </div>
            ...
            <li class="pcoded-hasmenu">
                ...
                <ul class="pcoded-submenu">
                	<c:if test="${perfil == 'Administrador'}">
	                    <li class=" ">
	                        <a href="<%= request.getContextPath() %>/ServletUserController?acao=listarutilizadores" class="waves-effect waves-dark">
	                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
	                            <span class="pcoded-mtext" data-i18n="nav.basic-components.alert">Cadastrar utilizador</span>
	                            <span class="pcoded-mcaret"></span>
	                        </a>
	                    </li>
                    </c:if>
